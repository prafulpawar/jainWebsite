...
export function HeroSection() {
  ...
  return (
    <section id="home" className="relative h-[70vh] min-h-[500px] overflow-hidden">
      ...
      <button
        onClick={prevSlide}
        className="absolute left-4 top-1/2 -translate-y-1/2 bg-card/30 hover:bg-card/50 backdrop-blur-sm p-3 rounded-full transition-all"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-4 top-1/2 -translate-y-1/2 bg-card/30 hover:bg-card/50 backdrop-blur-sm p-3 rounded-full transition-all"
      ...
      <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-maroon via-gold to-maroon" />
    </section>
  );
}
